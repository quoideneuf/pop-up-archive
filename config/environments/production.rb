PopUpArchive::Application.configure do
  ...
  config.assets.precompile += ['directory/base.css', 'directory/application.js', 'login/base.css', 'login.js', 'jplayer.popup.css', 'jquery.jplayer.js', 'pua_aa_stylesheet.css', 'jPlayer.css']
